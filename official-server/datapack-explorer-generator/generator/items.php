...
foreach($item_meta as $id=>$item)
{
	...
	$map_descriptor.='<div class="map item_details">';
        ...
        if(isset($item_to_crafting[$id]))
        {
            ...
            $map_descriptor.='<a href="'.$base_datapack_explorer_site_path.'items/'.text_operation_do_for_url($item_meta[$item_to_crafting[$id]['doItemId']]['name'][$current_lang]).'.html" title="'.$item_meta[$item_to_crafting[$id]['doItemId']]['name'][$current_lang].'">';
			...
			foreach($item_to_evolution[$id] as $evolution)
			{
				if(isset($monster_meta[$evolution['from']]) && isset($monster_meta[$evolution['to']]))
				{
					...
					if(file_exists($datapack_path.'monsters/'.$evolution['from'].'/front.png'))
						$map_descriptor.='<tr><td><a href="'.$base_datapack_explorer_site_path.'monsters/'.text_operation_do_for_url($monster_meta[$evolution['from']]['name'][$current_lang]).'.html"><img src="'.$base_datapack_site_path.'monsters/'.$evolution['from'].'/front.png" width="80" height="80" alt="'.$monster_meta[$evolution['from']]['name'][$current_lang].'" title="'.$monster_meta[$evolution['from']]['name'][$current_lang].'" /></a></td></tr>';
					else if(file_exists($datapack_path.'monsters/'.$evolution['from'].'/front.gif'))
						$map_descriptor.='<tr><td><a href="'.$base_datapack_explorer_site_path.'monsters/'.text_operation_do_for_url($monster_meta[$evolution['from']]['name'][$current_lang]).'.html"><img src="'.$base_datapack_site_path.'monsters/'.$evolution['from'].'/front.gif" width="80" height="80" alt="'.$monster_meta[$evolution['from']]['name'][$current_lang].'" title="'.$monster_meta[$evolution['from']]['name'][$current_lang].'" /></a></td></tr>';
					$map_descriptor.='<tr><td class="evolution_name"><a href="'.$base_datapack_explorer_site_path.'monsters/'.text_operation_do_for_url($monster_meta[$evolution['from']]['name'][$current_lang]).'.html">'.$monster_meta[$evolution['from']]['name'][$current_lang].'</a></td></tr>';
					$map_descriptor.='</table>';
					$map_descriptor.='</td>';
					$map_descriptor.='</tr>';

					$map_descriptor.='<tr><td class="evolution_type">Evolve with<br /><a href="'.$link.'" title="'.$item_meta[$id]['name'][$current_lang].'">';
					...
					if(file_exists($datapack_path.'monsters/'.$evolution['to'].'/front.png'))
						$map_descriptor.='<tr><td><a href="'.$base_datapack_explorer_site_path.'monsters/'.text_operation_do_for_url($monster_meta[$evolution['to']]['name'][$current_lang]).'.html"><img src="'.$base_datapack_site_path.'monsters/'.$evolution['to'].'/front.png" width="80" height="80" alt="'.$monster_meta[$evolution['to']]['name'][$current_lang].'" title="'.$monster_meta[$evolution['to']]['name'][$current_lang].'" /></a></td></tr>';
					else if(file_exists($datapack_path.'monsters/'.$evolution['to'].'/front.gif'))
						$map_descriptor.='<tr><td><a href="'.$base_datapack_explorer_site_path.'monsters/'.text_operation_do_for_url($monster_meta[$evolution['to']]['name'][$current_lang]).'.html"><img src="'.$base_datapack_site_path.'monsters/'.$evolution['to'].'/front.gif" width="80" height="80" alt="'.$monster_meta[$evolution['to']]['name'][$current_lang].'" title="'.$monster_meta[$evolution['to']]['name'][$current_lang].'" /></a></td></tr>';
					$map_descriptor.='<tr><td class="evolution_name"><a href="'.$base_datapack_explorer_site_path.'monsters/'.text_operation_do_for_url($monster_meta[$evolution['to']]['name'][$current_lang]).'.html">'.$monster_meta[$evolution['to']]['name'][$current_lang].'</a></td></tr>';
					$map_descriptor.='</table>';
					$map_descriptor.='</td>';
					$map_descriptor.='</tr>';
	...
	if(isset($items_to_quests[$id]))
	{
		...
		foreach($items_to_quests[$id] as $quest_id=>$quantity)
		{
			...
			{
				$map_descriptor.='<tr class="value">';
				$map_descriptor.='<td><a href="'.$base_datapack_explorer_site_path.'quests/'.$quest_id.'-'.text_operation_do_for_url($quests_meta[$quest_id]['name'][$current_lang]).'.html" title="'.$quests_meta[$quest_id]['name'][$current_lang].'">';
				$map_descriptor.=$quests_meta[$quest_id]['name'][$current_lang];
				$map_descriptor.='</a></td>';
	...
	if(isset($items_to_quests_for_step[$id]))
	{
		...
		foreach($items_to_quests_for_step[$id] as $items_to_quests_for_step_details)
		{
			...
			{
				$map_descriptor.='<tr class="value">';
				$map_descriptor.='<td><a href="'.$base_datapack_explorer_site_path.'quests/'.$items_to_quests_for_step_details['quest'].'-'.text_operation_do_for_url($quests_meta[$items_to_quests_for_step_details['quest']]['name'][$current_lang]).'.html" title="'.$quests_meta[$items_to_quests_for_step_details['quest']]['name'][$current_lang].'">';
            ...
            foreach($bot['step'] as $step_id=>$step)
            {
                if($step['type']=='fight')
                {
                    ...
                    if($bot['name'][$current_lang]=='')
                        ...
                        $map_descriptor.='><a href="'.$base_datapack_explorer_site_path.'bots/'.$link.'.html" title="'.$bot['name'][$current_lang].'">'.$bot['name'][$current_lang].'</a></td>';
	...
	filewrite($datapack_explorer_local_path.'items/'.text_operation_do_for_url($item['name'][$current_lang]).'.html',$content);
}