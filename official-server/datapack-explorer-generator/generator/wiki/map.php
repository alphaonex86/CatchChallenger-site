			...
			foreach($maps_list[$map]['borders'] as $bordertype=>$border)
			{
				if(!isset($duplicate[$border]))
				{
					...
					if(isset($maps_list[$border]))
						$map_descriptor.='<li>'.$translation_list[$current_lang]['Border '.$bordertype].': [['.$translation_list[$current_lang]['Maps:'].map_to_wiki_name($border).'|'.$maps_list[$border]['name'][$current_lang].']]</li>'."\n";
					else
			...
			foreach($maps_list[$map]['doors'] as $door)
			{
				if(!isset($duplicate[$door['map']]))
				{
					...
					if(isset($maps_list[$door['map']]))
						$map_descriptor.='<li>'.$translation_list[$current_lang]['Door'].': [['.$translation_list[$current_lang]['Maps:'].map_to_wiki_name($door['map']).'|'.$maps_list[$door['map']]['name'][$current_lang].']]</li>'."\n";
					else
			...
			foreach($maps_list[$map]['tp'] as $tp)
			{
				if(!isset($duplicate[$tp]))
				{
					...
					if(isset($maps_list[$tp]))
						$map_descriptor.='<li>'.$translation_list[$current_lang]['Teleporter'].': [['.$translation_list[$current_lang]['Maps:'].map_to_wiki_name($tp).'|'.$maps_list[$tp]['name'][$current_lang].']]</li>'."\n";
					else
