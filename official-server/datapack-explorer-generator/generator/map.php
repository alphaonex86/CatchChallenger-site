		...
		if(isset($bots_meta[$bot_on_map['id']]))
		{
			...
			foreach($bot['step'] as $step_id=>$step)
			{
				...
				else if($step['type']=='heal')
				{
					...
					<td><center><div style="width:128px;height:128px;background-image:url(\'/official-server/images/flags-big.png\');background-repeat:no-repeat;background-position:0px 0px;"></center></td>';
				}
				else if($step['type']=='learn')
				{
					$map_descriptor.='<td>Learn</td>
					<td><center><div style="width:128px;height:128px;background-image:url(\'/official-server/images/flags-big.png\');background-repeat:no-repeat;background-position:-384px 0px;"></center></td>';
				}
				else if($step['type']=='warehouse')
				{
					$map_descriptor.='<td>Warehouse</td>
					<td><center><div style="width:128px;height:128px;background-image:url(\'/official-server/images/flags-big.png\');background-repeat:no-repeat;background-position:0px -128px;"></center></td>';
				}
				...
				else if($step['type']=='clan')
				{
					...
					<td><center><div style="width:128px;height:128px;background-image:url(\'/official-server/images/flags-big.png\');background-repeat:no-repeat;background-position:-384px -128px;"></center></td>';
				}
				else if($step['type']=='sell')
				{
					$map_descriptor.='<td>Sell</td>
					<td><center><div style="width:128px;height:128px;background-image:url(\'/official-server/images/flags-big.png\');background-repeat:no-repeat;background-position:-256px 0px;"></center></td>';
				}
				else if($step['type']=='zonecapture')
				{
					$map_descriptor.='<td>Zone capture</td>
					<td><center><div style="width:128px;height:128px;background-image:url(\'/official-server/images/flags-big.png\');background-repeat:no-repeat;background-position:-256px 128px;"></center></td>';
				}
